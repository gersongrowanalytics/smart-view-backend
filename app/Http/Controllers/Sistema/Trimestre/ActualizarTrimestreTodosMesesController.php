...
class ActualizarTrimestreTodosMesesController extends Controller
{
    public function ActualizarTrimestreTodosMeses(Request $request)
    {
        ...
        $tris = trftrimestresfechas::where('fecid', $fecid)
                                    ->get();
                        ...
                        if($tsue){
                            ...
                            if($tsue->update()){
                                ...
                                if(sizeof($ttrs) > 0){
                                    ...
                                    $logs[$tri->fecid]["extras_noentra"][] = "sucid: ".$suc->sucid." fecid: ". $tri->fecid." triid: ".$tri->triid." treid: ".$suc->treid." ttrporcentajedesde <= ".round($tsucumplimientotrimestral)." ttrporcentajehasta >= ".round($tsucumplimientotrimestral);
                                }
