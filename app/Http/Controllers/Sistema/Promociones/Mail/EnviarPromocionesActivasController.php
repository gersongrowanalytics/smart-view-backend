        ...
        if (true == true) {
            ...
            if (sizeof($usuariosCorreo) > 0) {
                ...
                foreach ($suc_unicos as $key => $suc_unico) {
                    ...
                    Mail::to($usuarios_correo)->cc(['0540Peru.salescontrolling@kcc.com', 'Cuidatunegocio.KC@kcc.com', 'gerson.vilca@grow-analytics.com.pe', 'eunice.calle@grow-analytics.com.pe'])
                                                ->send(new MailPromocionesActivas($data_correo, $asunto_correo));
