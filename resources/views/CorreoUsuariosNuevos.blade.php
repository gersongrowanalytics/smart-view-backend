            ...
            <div style="width: 440px;">
                ...
                <table border="0" cellspacing="0" cellpadding="0" style="width: 100%"> 
                    ...
                    <tr >
                        <td style="background: #edf0f3; width: 30px"></td>
                        <td colspan="6"  align="center">
                            <div style="margin-left: 60px; margin-right: 60px; margin-bottom:15px; margin-top:5px">
                                <span style=" font-style: normal; font-weight: bold; font-size: 12px; line-height: 12px; color: #4d4d4d; ">
                    ...
                    <tr>
                        ...
                        <td colspan="6" align="center" >
                            <div style="margin-bottom:15px">
                                <span style=" font-style: normal; font-weight: normal; font-size: 13px; line-height: 12px; color: #9c9b9b;">
                                    Para iniciar sesión debes ingresar con el siguiente </br> usuario y contraseña 
                                </span>
                            </div>
                        </td>
                        <td style="background: #edf0f3; width: 30px"></td>
                    ...
                    <tr>
                        <td style="background: #edf0f3; width: 30px"></td>
                        <td colspan="6" align="center">
                            <div style="margin-left: 10px; margin-right: 10px; font-style: normal; font-weight: normal; font-size: 12px; line-height: 12px; color: #9c9b9b;">
                                Usuario
                            </div>
                        </td>
                        <td style="background: #edf0f3; width: 30px"></td>
                    ...
                    <tr>
                        <td style="background: #edf0f3; width: 30px"></td>
                        <td colspan="6" align="center">
                            <div style="margin-left: 10px; margin-right: 10px; margin-top: 5px; font-style: normal; font-weight: normal; font-size: 12px; line-height: 12px; color: #4d4d4d">
                                {{$usuario}}
                            </div>
                        </td>
                        <td style="background: #edf0f3; width: 30px"></td>
                    ...
                    <tr>
                        <td style="background: #edf0f3; width: 30px"></td>
                        <td colspan="6" align="center">
                            <div style="margin-left: 10px; margin-right: 10px; margin-top: 10px; font-style: normal; font-weight: normal; font-size: 12px; line-height: 12px; color: #9c9b9b;">
                                Contraseña
                            </div>
                        </td>
                        <td style="background: #edf0f3; width: 30px"></td>
                    ...
                    <tr>
                        <td style="background: #edf0f3; width: 30px"></td>
                        <td colspan="6" align="center">
                            <div style="margin-left: 10px; margin-right: 10px; margin-top: 5px; margin-bottom: 30px; font-style: normal; font-weight: normal; font-size: 12px; line-height: 12px; color: #4d4d4d">
                                {{$contrasenia}}
                            </div>
                        </td>
                        <td style="background: #edf0f3; width: 30px"></td>
