        ...
        <Center>
            <div style="width: 370px; ">
                <div id="piesCorreo" style="background: #558CFF; margin-top:30px; height: 40px; width: 370px; padding-top: 0px; position:relative">
                    ...
                    <div 
                        id="" 
                        style="font-family: Roboto; font-style: normal; font-weight: 900; font-size: 18px; line-height: 21px; color: #FFFFFF; padding-top:10px;">
                        Creciendo Juntos
                    </div>
                </div>
                <table>
                ...
                <div id="piesCorreo" style="background: #ECF1FA; margin-top:30px; height: 40px; width: 370px;">
                    <div 
                        id="" 
                        style="font-family: Roboto; font-style: normal; font-weight: bold; font-size: 9px; line-height: 11px; color: #4157BD; padding-top:15px;">
