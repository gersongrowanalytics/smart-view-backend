    ...
    <div style="width: 100%;">
        <center>
            <div style="width: 370px; border: 1px solid #E7F3FF;">
                <div id="piesCorreo"
                    style="background: #FFFFF; margin-top:30px; height: 40px; width: 370px; padding-top: 0px; position:relative">
                    <div id=""
                    ...
                    <tr>
                        <td align="center" style=" width: 100000px;">
                            <div id=""
                                ...
                                Hemos recibido un nuevo archivo en la<br> plataforma de SmartView.
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center" style=" width: 100000px;">
                            <div id=""
                                ...
                                <a href="{{ $linkArchivoSubido }}">{{ $nombre }}</a>
