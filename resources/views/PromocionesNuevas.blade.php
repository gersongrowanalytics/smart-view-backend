                    ...
                    <tr>
                        <td style="width: 100%;">
                            <div style="width: 100%">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" style="padding-top: 32px; padding-left: 67px; padding-right: 66px">
                                    <tr>
                                    ...
                                    <tr style="padding-top: 23px;">
                                        <td colspan="3" align="center">
                                            <div style="padding-top: 23px; font-style: normal; font-weight: 400; font-size: 11px; line-height: 15px; color: #1E1E1E;">
                                                En caso tengas problemas para ingresar en el botón, ingresar al siguiente enlace: <a href="https://smartview.grow-corporate.com/sistema/promociones">https://smartview.grow-corporate.com/sistema/promociones</a>
                                            </div>
                                        </td>
                                    </tr>
