                    ...
                    <tr>
                        <td align="center" style=" width: 100000px; margin-bottom:15px">
                            <div style="margin-bottom:15px">
                                <a 
                                    id="btnPlataforma" 
                                    href="https://smartview.grow-corporate.com/cambiar-contrasenia/{{$token}}"
                    ...
                    <tr>
                        <td align="center" style=" width: 100000px">
                            <div style="margin-left: 10px; margin-right: 10px; margin-top:10px">
                                <span style=" font-style: normal; font-weight: normal; font-size: 10px; line-height: 12px; color: #9C9B9B;">
                                    En caso tengas problemas para cambiar tu contraseña, ingresar al siguiente enlace:<br> <a style="text-decoration: none; color: #558CFF;" href="https://smartview.grow-corporate.com/cambiar-contrasenia/{{$token}}" >https://smartview.grow-corporate.com/cambiar-contrasenia/{{$token}}</a>
                                </span>
                            </div>
                        </td>
                    </tr>
