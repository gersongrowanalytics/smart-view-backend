...
$router->group(['middleware' => ['permisos']], function() use($router) {
    ...
    $router->post('/cargarArchivo/prueba/soldtos', 'Sistema\CargarArchivo\Productos\PruebaController@prueba');
    $router->post('/cargarArchivo/prueba', 'Sistema\CargarArchivo\Prueba\ProductosCargarController@CargarProductos');
